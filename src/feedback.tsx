...
type FeedbackKind = EffectKind | 'start';
    ...
    {open && <div className="audio-settings-panel" role="dialog" aria-label="Preferencias de la app">
      ...
      <div className="audio-preference vibration-preference">
        ...
        {vibrationReport && <div className="vibration-result" role="status" aria-label="Diagnóstico de vibración">
          ...
          {vibrationReport.returned === true && <small>Solicitud aceptada; si no vibra, revisa el modo silencio y los ajustes del móvil.</small>}
        </div>}
      </div>

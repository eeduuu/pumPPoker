...
test('Creación real usa dealer válido y baraja nueva',()=>{
 ...
 assert.doesNotThrow(()=>createInitialHand({bots:1,chips:5000,small:40,big:85}));
 assert.throws(()=>createInitialHand({bots:1,chips:5000,small:5,big:85}),/Proporción de ciegas/);
});
